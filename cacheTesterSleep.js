...
function runRound() {
  ...
  **/
  ...
  accessMiss1.push(Math.floor(diffTime1 * 100000)); accessHit1.push(Math.floor(diffTime2 * 100000)); accessHit2.push(Math.floor(diffTime3 * 100000));
...
plot1 = $.jqplot("chart1", {
  title: "Access Latencies : accessMiss vs accessHit",
  cursor: {
      show: false
  },
  highlighter: {
