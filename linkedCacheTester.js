...
for (var round = 0; round < numRounds; round++) {
  ...
  **/
  ...
  accessMiss1.push(Math.floor(diffTime1 * 100000));
  accessHit1.push(Math.floor(diffTime2 * 100000));
  accessHit2.push(Math.floor(diffTime3 * 100000));
  accessMiss2.push(Math.floor(diffTime4 * 100000));
}

var accessMiss1Data = toPD(accessMiss1);
var accessHit1Data = toPD(accessHit1);
var accessHit2Data = toPD(accessHit2);
var accessMiss2Data = toPD(accessMiss2);

// jqplot data visualization
plot1 = $.jqplot("chart1", [accessMiss1Data, accessHit1Data, accessHit2Data, accessMiss2Data], {
  title: "Access Latencies : Access-Miss vs Access-Hit",
  cursor: {
      show: false
  },
  highlighter: {
